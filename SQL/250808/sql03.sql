...
# 클러스터형 인덱스, 보조형 인덱스가 다른 필드 값에 있는 요소들을 사용할 때보다 연산처리 속도가 빠르다는 것을 확인 
# 우선, 여러분들의 MySQL안에 설정 및 설치되어있는 스토리지 엔진 (Storage Engine)
# ENGINE = InnoDB
...
FROM information_schema.tables LIMIT 1000; # 더미 데이터 

SELECT COUNT(*) FROM customers;
SELECT * FROM customers;

# information_schema.tables
# 현재 내가 사용하고 있는 MySQL 워크벤치 안에 있는 전체 테이블 정보값을 가지고 있는 시스템 테이블 = 메타테이블
